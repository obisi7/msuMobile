...
const ITEM_WIDTH = Dimensions.get("window").widget;
...
const url =
  "https://api.flickr.com/services/rest/?&method=flickr.people.getPublicPhotos&api_key=c63979f705d43372fefbfacc6f011bac&user_id=46262470@N03&format=json&&per_page=20&nojsoncallback=1"; // MSU flickr
    ...
    return (
      fetch(url)
        ...
        .then(responseJson => {
          ...
          // let concatImageData = newImageData.concat(responseJson.results);
